=== Plugin Name ===
Contributors:      rajubdpro, codepopular
Author:            rajubdpro
...
1. Upload `simple-wp-content-protector` Folder to the `/wp-content/plugins/` directory
...
= 1.0.1 =
* This is second version no known errors found
= 1.0.2 =
* This is third version no known errors found
